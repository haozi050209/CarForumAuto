...
import com.yonyou.friendsandaargang.hIndicator.listener.OnDismissListener;
...
public class HIndicatorBuilder {
    ...
    protected HIndicatorAdapter mAdapter;
    ...
    public HIndicatorBuilder adapter(HIndicatorAdapter adapter) {
