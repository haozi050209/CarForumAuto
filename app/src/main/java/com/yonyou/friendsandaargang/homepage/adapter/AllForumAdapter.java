...
public class AllForumAdapter extends BaseAdapter {
    ...
    private List<AllForums.ContentBean> list;


    public AllForumAdapter(Context context, List<AllForums.ContentBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.list_all_forums, null, false);
        ...
        viewHodler.all_forums_name.setText(list.get(position).getForumName());
        return convertView;
    }
    ...
    public class ViewHodler {
        ...
        CircleImageView all_forums_image;
