...
public class AllPostAdapter extends BaseAdapter {
    ...
    private List<AllSearch.ContentBean.PostBean.AttachmentListBean> list;

    public AllPostAdapter(Context context, List<AllSearch.ContentBean.PostBean.AttachmentListBean> list) {
