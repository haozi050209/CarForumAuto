...
public class WenDaMessageAdapter extends BaseAdapter {
    ...
    public WenDaMessageAdapter(Context context, List<ForumMessage.ContentBean> beanList) {
    ...
    public void notifyDataSetChanged(List<ForumMessage.ContentBean> beanList) {
