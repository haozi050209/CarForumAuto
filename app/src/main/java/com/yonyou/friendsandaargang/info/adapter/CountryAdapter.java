...
public class CountryAdapter extends BaseAdapter {
    ...
    public CountryAdapter(Context context, List<Country.ContentBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.list_country_item, null, false);
            viewHodler = new ViewHodler(convertView);
            convertView.setTag(viewHodler);
        } else {
            viewHodler = (ViewHodler) convertView.getTag();
        }
        viewHodler.country_item_name.setText(list.get(position).getCountry());
        return convertView;
    }
