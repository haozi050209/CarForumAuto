...
import static com.yonyou.friendsandaargang.utils.FileTool.getDataColumn;
import static com.yonyou.friendsandaargang.utils.FileTool.isDownloadsDocument;
import static com.yonyou.friendsandaargang.utils.FileTool.isExternalStorageDocument;
import static com.yonyou.friendsandaargang.utils.FileTool.isGooglePhotosUri;
import static com.yonyou.friendsandaargang.utils.FileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtils.error("请先获取写入SDCard权限");
        } else {
